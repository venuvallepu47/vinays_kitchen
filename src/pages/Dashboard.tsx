        ...
        <div className="pb-24">
            ...
            <div className="bg-gradient-to-b from-amber-800 via-amber-700 to-orange-600 px-4 pt-5 pb-8 relative overflow-hidden">
                ...
                <div className="grid grid-cols-2 gap-3 relative">
                    <div className="bg-white/10 rounded-2xl p-4 border border-white/10 text-left">
                        <p className="text-amber-200 text-[10px] font-bold uppercase tracking-widest mb-1.5">Today's Counter</p>
                        <p className="text-white text-[22px] font-black leading-none">{formatCurrency(s.today_sales || 0)}</p>
                        <p className="text-amber-300/70 text-[10px] mt-1.5">total sales today</p>
                    </div>
                    <div className="bg-white/10 rounded-2xl p-4 border border-white/10 text-left">
